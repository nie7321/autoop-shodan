...
typedef struct shodanfuncs_s
{
	...
	void		(*pfnCreateLight)			(int r, int g, int b, int x, int y, int z);
	void		(*pfnCreateEntity)			(int x, int y, int z, int anglex, int angley, int anglez, char *szClassname);
