...
//Misc. Remote-X Subs
extern void UTIL_DumpPlayerInfo ( void );
extern void UTIL_ProcessExternalCommands (char *command, char *playername, char *params);
extern int UTIL_GetPlayerIndex (char *PlayerText);
extern void UTIL_GiveWeapon (int code, CBaseEntity *pEntity);
extern void ClientPrint( entvars_t *client, int msg_dest, const char *msg_name, const char *param1, const char *param2, const char *param3, const char *param4 );
extern char* stristr( const char* haystack, const char* needle );
int make_friendly(char *);
extern int UTIL_SpectCheck( edict_t *pPlayer );
extern CBaseEntity *UTIL_FindEntityByTargetname( CBaseEntity *pStartEntity, const char *szName );
extern bool UTIL_CheckBox(Vector Origin, Vector Dimensions);
extern int UTIL_GetRank( int credits );
extern int GetPartialPlayerIndex(char *PlayerText, int SelfIndex);
extern void fix_string(char *str,int len);
extern int IsMorePowerful(int Index1, int Index2);
extern void TFXGiveWeapon( int code, edict_t *pEntity );
extern void TakeDamage(edict_t *pEntity, edict_t* pAttacker, float flDamage, int DamageType);
extern int GetEntAmountState();
extern int GetNumberOFFreeEnts();
extern void UTIL_GiveAllWeapons( CBaseEntity *pEntity );
